...
namespace VolumetricLines
{
	...
	public class CarTrailDopeAF : MonoBehaviour 
	{
		...
		void Start () 
		{
            ...
            /*************
             * 
             * Come up with three points and get the tral going mofoc
             */
            m_lineVertices = new Vector3[5];
            m_lineVertices[0] = transform.position;
            m_lineVertices[1] = new Vector3(transform.position.x - 5.0f, transform.position.y, transform.position.z);
            m_lineVertices[2] = new Vector3(transform.position.x - 10.0f, transform.position.y, transform.position.z);
            m_lineVertices[3] = new Vector3(transform.position.x - 15.0f, transform.position.y, transform.position.z);
            m_lineVertices[4] = new Vector3(transform.position.x - 20.0f, transform.position.y, transform.position.z);
		...
		void Update()
		{
            ...
            //Remove a point and add a new one
            m_lineVertices = new Vector3[5];
            m_lineVertices[0] = transform.position;
            m_lineVertices[1] = new Vector3(transform.position.x - 5.0f, transform.position.y, transform.position.z);
            m_lineVertices[2] = new Vector3(transform.position.x - 10.0f, transform.position.y, transform.position.z);
