        ...
        for (int i = 0; i < actionTypeFlagCount; ++i)
		{
            ...
            if (maskedActionTypeFlag != 0)
			{
				...
				if(displayFoldout)
				{
					...
					//string assetPath = "Assets/Data/Mover/" + moverComponent.gameObject.name + "_" + maskedActionTypeFlag.ToString() + "MoverBehavior.asset";
					//MoverBehavior moverBehavior = (MoverBehavior)AssetDatabase.LoadAssetAtPath(assetPath, typeof(MoverBehavior));
					...
					//	//if (moverBehavior != null && moverBehaviorType.Equals(Mover.BehaviorType.Undefined))
					//	//{
					...
					//if(moverBehavior == null && !moverBehaviorType.Equals(Mover.BehaviorType.Undefined))
					//{
					//	moverBehavior = Mover.createMoverBehavior(moverBehaviorType);
					//	AssetDatabase.CreateAsset(moverBehavior, assetPath);
					...
					if (EditorGUI.EndChangeCheck())
					{
						//Undo.RecordObject(mover, "Surface Checker Transform");
					...
					//		mover.setBehaviorType(Mover.BehaviorType.LinearInput);
					//	}
					...
					//		mover.setBehaviorType(Mover.BehaviorType.RigidBodyForceInput);
					//	}
					...
					//		mover.setBehaviorType(Mover.BehaviorType.AttachToSurface);
					//	}
